...
class $AssetsCommonGen {
  ...
  /// File path: assets/common/logo-dark-transparent.png
  AssetGenImage get logoDarkTransparent =>
      const AssetGenImage('assets/common/logo-dark-transparent.png');
  ...
  List<AssetGenImage> get values =>
      [logoDarkTransparent, logoTransparent, logo];
}
...
class $AssetsJsGen {
  ...
  /// File path: assets/js/deup.min.js
  String get deupMin => 'assets/js/deup.min.js';

  /// List of all assets
  List<String> get values => [deupMin];
}
